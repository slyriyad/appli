...
<body class="recapBody">
    <div id="wrapper" class="h-100 d-flex flex-column justify-content-center align-items-center">
    <header class="display-3" style="color: rgb(0, 123, 255); margin-bottom: 50px; line-height: 105px; font-weight: 600;" >
        LE MARCHÉ.
    </header>
    <div id="btnRecap">
        <a type="button" class="btn btn-light position-relative" href="index.php">
            Ajouter produit
        </a>
        <a type="button" class="btn btn-primary position-relative" href="recap.php">
            Panier
        </a>    
